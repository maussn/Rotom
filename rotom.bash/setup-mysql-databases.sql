...
DROP USER '${ROTOM_READER_ACCOUNTS_USERNAME}'@'localhost';
DROP USER '${ROTOM_READER_ITEMS_USERNAME}'@'localhost';
DROP USER '${ROTOM_READER_LOANS_USERNAME}'@'localhost';
...
CREATE user '${ROTOM_READER_ACCOUNTS_USERNAME}'@'localhost' IDENTIFIED BY '${ROTOM_READER_ACCOUNTS_PASSWORD}';
GRANT INSERT, SELECT, UPDATE, DELETE ON rotom.accounts TO '${ROTOM_READER_ACCOUNTS_USERNAME}'@'localhost';

CREATE user '${ROTOM_READER_ITEMS_USERNAME}'@'localhost' IDENTIFIED BY '${ROTOM_READER_ITEMS_PASSWORD}';
GRANT INSERT, SELECT, UPDATE, DELETE ON rotom.items TO '${ROTOM_READER_ITEMS_USERNAME}'@'localhost';

CREATE user '${ROTOM_READER_LOANS_USERNAME}'@'localhost' IDENTIFIED BY '${ROTOM_READER_LOANS_PASSWORD}';
GRANT INSERT, SELECT, UPDATE, DELETE ON rotom.loans TO '${ROTOM_READER_LOANS_USERNAME}'@'localhost';